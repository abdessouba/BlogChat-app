...
function MyComponent({params}) {
  ...
  return (
    <AnimationWrapper>
      <div className="w-[80%] m-auto flex items-start justify-center gap-7 mb-16">
        <Toaster />
        <aside className="w-[300px] h-full border-r-4 border-gray-100">
          ...
          <div className="my-6 text-gray-500">
            <Link
              href="/profile/show"
              className={`${pageRoute && pageRoute[0] === "show" ? "ml-5" : ""} text-xl flex items-center gap-1 mb-2 hover:bg-gray-50 py-4 px-3 rounded-xl transition-all duration-200 cursor-pointer hover:ml-5`}
            >
              <Image
                src={profile}
                alt="image"
            ...
            <Link
              href="/profile/manage"
              className={`${pageRoute && pageRoute[0] === "manage" ? "ml-5" : ""} text-xl flex items-center gap-1 mb-2 hover:bg-gray-50 py-4 px-3 rounded-xl transition-all duration-200 cursor-pointer hover:ml-5`}
            >
            ...
            <Link
              href="/profile"
              className={`${pageRoute && pageRoute[0] === "notification" ? "ml-5" : ""} text-xl flex items-center gap-1 mb-2 hover:bg-gray-50 py-4 px-3 rounded-xl transition-all duration-200 cursor-pointer hover:ml-5`}
            >
              <Image
                src={notification}
                alt="image"
          ...
          <div className="my-6 text-gray-500">
            <Link
              href="/profile/edit"
              className={`${pageRoute && pageRoute[0] === "edit" ? "ml-5" : ""} text-xl flex items-center gap-1 mb-2 hover:bg-gray-50 py-4 px-3 rounded-xl transition-all duration-200 cursor-pointer hover:ml-5`}
            >
              <Image
                src={profile}
                alt="image"
            ...
            <Link
              ...
              className={`${pageRoute && pageRoute[0] === "password" ? "ml-5" : ""} text-xl flex items-center gap-1 mb-2 hover:bg-gray-50 py-4 px-3 rounded-xl transition-all duration-200 cursor-pointer hover:ml-5`}
            >
          ...
          <AnimationWrapper>
            <main className="ml-5 text-gray-600 flex items-start gap-7 w-[900px] ">
